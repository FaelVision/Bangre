...
export default async function StudentDetailPage({ params }: { params: Promise<{ studentId: string }> }) {
  ...
  return (
    <div>
      ...
      <div className="p-5.5 px-7 pb-10 grid gap-3.5" style={{ gridTemplateColumns: "320px 1fr", alignItems: "start" }}>
            ...
            <Card>
              ...
              <div className="grid gap-2.5">
                {summary.trancheStates.map((ts) => (
                  <div
                    key={ts.tranche.id}
                    className="flex items-center gap-3.5 rounded-[11px] px-4 py-3.5 border"
                    style={{
                      borderColor:
