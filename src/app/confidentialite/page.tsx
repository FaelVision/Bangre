...
/**
 * Politique de confidentialité publique de Bangré — requise pour publier le
    ...
    <div className="min-h-screen bg-(--color-bg-page) flex justify-center px-5 py-12">
      <div className="w-full max-w-[680px]">
        ...
        <p className="text-[13.5px] text-(--color-text-secondary) leading-relaxed mt-5">
          Bangré est un logiciel de gestion de la scolarité destiné aux établissements scolaires (écoles, collèges,
          lycées) au Burkina Faso. Cette page explique quelles données sont collectées lors de l&apos;utilisation de
          Bangré, dans quel but, et comment elles sont protégées.
        </p>

        <Section title="Qui est responsable de vos données">
          <p>
            Bangré est édité par FasoLink. Pour toute question relative à cette politique ou à vos données, vous
            pouvez écrire à{" "}
        ...
        <Section title="Connexion avec Google">
          <p>
            Bangré propose de se connecter avec un compte Google en plus de la connexion par numéro de téléphone.
            Lorsque vous choisissez cette option, Google nous transmet votre adresse e-mail, votre nom et votre
            photo de profil, uniquement afin de créer ou reconnaître votre compte établissement. Bangré ne demande
        ...
        <Section title="Données des élèves et des paiements">
          ...
          <p>
            ...
            compte et à l&apos;équipe technique de Bangré lorsque c&apos;est strictement nécessaire (support,
            maintenance).
          </p>
        </Section>
        ...
        <Section title="Cookies">
          <p>
            Bangré utilise un unique cookie technique, nécessaire au fonctionnement du service : il maintient la
        ...
        <Section title="Vos droits">
          <p>
            ...
            en écrivant à l&apos;adresse ci-dessus. Une personne dont les coordonnées figurent dans Bangré en tant
