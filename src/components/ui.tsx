...
export function PageHeader({
  ...
  return (
    <div className="border-b border-(--color-border) bg-(--color-bg-app) px-4 py-3.5 flex flex-col items-stretch gap-3 lg:sticky lg:top-0 lg:z-10 lg:h-[70px] lg:flex-row lg:items-center lg:gap-3.5 lg:px-7 lg:py-0">
      <div className="min-w-0">
        {eyebrow && <div className="text-[12.5px] text-(--color-text-muted)">{eyebrow}</div>}
        <div className="text-[17px] lg:text-[19px] font-semibold tracking-tight mt-0.5">{title}</div>
