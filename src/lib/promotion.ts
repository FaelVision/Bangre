...
/**
 * The school year a new establishment should start on, e.g. "2026-2027".
 *
 * Classes run from around October to June. From July onwards the year that
 * just ended is over and enrolment for the next one has begun, so a school
 * signing up in, say, August is preparing the year that starts that autumn —
 * not the one that finished in June.
 */
